...
public class CThostFtdcSyncDelaySwapField {
  ...
  protected static long swigRelease(CThostFtdcSyncDelaySwapField obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setIsManualSwap(int value) {
    thosttraderapiJNI.CThostFtdcSyncDelaySwapField_IsManualSwap_set(swigCPtr, this, value);
  }

  public int getIsManualSwap() {
    return thosttraderapiJNI.CThostFtdcSyncDelaySwapField_IsManualSwap_get(swigCPtr, this);
  }

  public void setIsAllRemainSetZero(int value) {
    thosttraderapiJNI.CThostFtdcSyncDelaySwapField_IsAllRemainSetZero_set(swigCPtr, this, value);
  }

  public int getIsAllRemainSetZero() {
    return thosttraderapiJNI.CThostFtdcSyncDelaySwapField_IsAllRemainSetZero_get(swigCPtr, this);
  }
